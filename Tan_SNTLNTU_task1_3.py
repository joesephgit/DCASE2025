...
from Tan_SNTLNTU_task1.models.ntu_baseline_3 import get_ntu_model
from Tan_SNTLNTU_task1.models.multi_device_model import MultiDeviceModelContainer
...
def load_model(model_file_path: Optional[str] = None) -> Baseline:
    ...
    if model_file_path is None:
        with pkg_resources.path(ckpts, "task1_3.ckpt") as ckpt_path:
