...
def load_model(model_file_path: Optional[str] = None) -> Baseline:
    ...
    #model_file_path = 'C:/BL1/DCASE24_Task1/m5s9pf79/checkpoints/epoch=135-step=18632.ckpt'


    # Use default checkpoint from package resources if no path is given
    if model_file_path is None:
        with pkg_resources.path(ckpts, "task1_2.ckpt") as ckpt_path:
